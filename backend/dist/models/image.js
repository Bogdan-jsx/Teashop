...
var ImageTable = /** @class */ (function (_super) {
    __extends(ImageTable, _super);
    function ImageTable() {
    ...
    ], ImageTable.prototype, "link", void 0);
    __decorate([
        ForeignKey(function () { return Product; })
    ], ImageTable.prototype, "productId", void 0);
    ImageTable = __decorate([
        Table
    ], ImageTable);
    return ImageTable;
}(Model));
